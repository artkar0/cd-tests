...
os.system('rm ./OUT_P95/* > /dev/null 1> /dev/null 2> /dev/null')
...
def prepare(x, elements):
    ...
    os.system("cp ./TEMP/"+str(i)+".png ./OUT_P95/"+l[1].replace('#','_')+'_'+str(i)+'.png')

    plik_details = './OUT_P95/'+l[1].replace('#','_')+'.html'
...
for x in lista:
	...
	if os.path.isfile("./"+l[1]+"/01.jpg"):
	    os.system("cp ./"+l[1]+"/01.jpg ./OUT_P95/"+l[1].replace('#','_')+"_01.jpg")
	else:
	    os.system("cp ./blank.jpg ./OUT_P95/"+l[1].replace('#','_')+"_01.jpg")
	if os.path.isfile("./"+l[1]+"/02.jpg"):
	    os.system("cp ./"+l[1]+"/02.jpg ./OUT_P95/"+l[1].replace('#','_')+"_02.jpg")
	else:
	    os.system("cp ./blank.jpg ./OUT_P95/"+l[1].replace('#','_')+"_02.jpg")
	if os.path.isfile("./"+l[1]+"/03.jpg"):
	    os.system("cp ./"+l[1]+"/03.jpg ./OUT_P95/"+l[1].replace('#','_')+"_03.jpg")
	else:
	    os.system("cp ./blank.jpg ./OUT_P95/"+l[1].replace('#','_')+"_03.jpg")
	info = './'+l[1]+'/info.html'
	html += '<hr>'
...
plik = open("./OUT_P95/index.html", "w")
plik.write(html)
plik.close()
